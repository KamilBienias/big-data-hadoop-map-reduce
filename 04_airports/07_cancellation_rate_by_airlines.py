# Etap9. Odcinek: Rozwiazanie: Wskaznik odwolan lotow w rozbiciu na linie lotnicze

from mrjob.job import MRJob
from mrjob.step import MRStep

# uruchomienie:
# python3 07_cancellation_rate_by_airlines.py flights.csv --airlines airlines.csv
# zapis do pliku:
# python3 07_cancellation_rate_by_airlines.py flights.csv --airlines airlines.csv > cancellation_rate.csv
class MRFlight(MRJob):
    ...
    def mapper(self, _, line):
        ...
        # zwraca kod 2-literowy jako klucz
    ...
    def reducer(self, key, values):
        ...
        for value in values:
            total += value
            num_rows += 1
        #     samo key daloby kod 2-literowy zamiast pelnej nazwy linii.
        # Wartoscia jest suma opoznien przez ilosc wszystkich lotow
