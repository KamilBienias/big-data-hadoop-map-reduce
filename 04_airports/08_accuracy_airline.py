# Etap9. Odcinek: Rozwiazanie: Wskaznik dokladnosci rozkladu w rozbiciu na linie lotnicze

from mrjob.job import MRJob
from mrjob.step import MRStep

# uruchomienie
# python3 08_accuracy_airline.py flights.csv --airlines airlines.csv > accuracy_airline.csv
class MRAccuracyAirline(MRJob):
    ...
    # kluczem jest airline bo taki byl klucz po yield z mappera
    def reducer(self, key, values):
        ...
        for value in values:
            ...
            total_arr += value[1]
            num_rows += 1
        #     zeby miec pelna nazwe to korzysta ze slownika
