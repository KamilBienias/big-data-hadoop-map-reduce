# Etap9. Odcinek: MapReduce: Srednie opoznienie odlotu i przylotu w rozbiciu na linie lotnicze + pelne nazwy

from mrjob.job import MRJob
from mrjob.step import MRStep

# tak uruchamiac:
# python3 06_average_departue_arrival_delay_by_airline_with_names.py flights.csv --airlines airlines.csv
# zapis do pliku average_delay_by_airline.csv:
# python3 06_average_departue_arrival_delay_by_airline_with_names.py flights.csv --airlines airlines.csv > average_delay_by_airline.csv
class MRFlight(MRJob):
    ...
    def configure_args(self):
        # beda wykonane wszystkie rzeczy zaimplementowane w tej metodzie
    ...
    # odczytuje airlines.csv i zapisuje go do slownika
