# Etap12. Odcinek: Rozwiazanie: Srednia dlugosc trasy kursu taksowki

from mrjob.job import MRJob
from mrjob.step import MRStep

# zapis do pliku:
# python3 05_average_trip_distance.py yellow_tripdata_2016-01.csv > average_trip_distance.csv
class MRTaxi(MRJob):
    ...
    def mapper(self, _, line):
        ...
        # nie ma klucza bo chce dla wszyskich kursow srednia policzyc
